...
The project uses `.mud` as the model descriptor extension.
The file body remains INI-style:
...
`basic.model` is resolved relative to the `.mud` file location. Under the
