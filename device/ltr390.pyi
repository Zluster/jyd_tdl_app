...
class LTR390(LS):
    ...
    def __init__(self, i2c_bus: I2C | int | str, addr: int = ..., mode: LTR390Mode = ..., gain: LTR390Gain = ..., resolution: LTR390Resolution = ..., threshold: tuple[int, int] | None = ..., *, window_factor: float = ..., auto_open: bool = ...) -> None:
