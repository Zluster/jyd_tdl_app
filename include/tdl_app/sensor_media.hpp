...
class SensorMedia {
 public:
  ...
  static Config dualOsAttach(const std::string &sensor_ini) {
    Config config = attachExisting(
        sensor_ini, true, 0, 0, 0, DualOsLayout::kCaptureVpssGroup,
        DualOsLayout::kAiChannel, DualOsLayout::kAiWidth,
        DualOsLayout::kAiHeight, 18);
    config.vpss_outputs.push_back(vpssOutput(
        DualOsLayout::kCaptureVpssGroup, DualOsLayout::kMainChannel,
        DualOsLayout::kMainWidth, DualOsLayout::kMainHeight, 18, false));
    config.vpss_outputs.push_back(vpssOutput(
        DualOsLayout::kCaptureVpssGroup, DualOsLayout::kLiveChannel,
        DualOsLayout::kLiveWidth, DualOsLayout::kLiveHeight, 18, false));
    config.vpss_outputs.push_back(vpssOutput(
        DualOsLayout::kCaptureVpssGroup, DualOsLayout::kSubRgbChannel,
        DualOsLayout::kSubRgbWidth, DualOsLayout::kSubRgbHeight, 2, false));
    return config;
  }

  static SensorProfile cv2003Profile() {
    return {"cv2003", "./configs/sensor_cfg_cv2003.ini",
