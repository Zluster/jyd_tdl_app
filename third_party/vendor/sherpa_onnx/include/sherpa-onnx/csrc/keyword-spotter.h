...
struct KeywordResult {
  ...
  /// Mean acoustic probability of the matched keyword tokens.
  float confidence = 0;

  /// Per-keyword acoustic prefix scores for the latest decoded chunk.
  std::vector<std::string> score_keywords;
  std::vector<float> keyword_scores;
